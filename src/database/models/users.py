...
class Users(Base):
    ...
    cpf: Mapped[str] = mapped_column(String(12), unique=True, nullable=True, index=True)
    age: Mapped[int] = mapped_column(Integer, nullable=True)
    gender: Mapped[Literal["male", "female", "other"]] = mapped_column(String(15), nullable=True)
